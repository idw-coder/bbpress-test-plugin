			...
			<form id="new-post" name="new-post" method="post">
				...
				<fieldset class="bbp-form">
					...
					<?php if (current_user_can('unfiltered_html')) : ?>
						...
						<div class="bbp-template-notice" style="display: none;">
							<ul>
					...
					<div>
						...
						<div class="bbp-submit-wrapper">
							...
							<button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit bg-blue-500 hover:bg-blue-600 text-white !border-none"><?php esc_html_e('Submit', 'bbpress'); ?></button>
